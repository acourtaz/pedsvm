...
% controls to browse ministacks
   ...
   uicontrol('callback','browseEvFT previousEvent','string','PREVIOUS',...
       'position',[20,300,70,15])
   uicontrol('callback','browseEvFT nextEvent','string','NEXT',...
       'position',[20,285,70,15])
   uicontrol('style','text','string','#','position',[20,270,10,15],...
       'tag','coeff','userdata',coeff)
   
   uicontrol('string','Go','callback','browseEvFT gotoEvent',...
...
uicontrol('callback','browseEvFT goto','tag','frame#',...
      'style','slider',...
...
%set(findobj(children,'tag','frame#'),'value',frame)
if evnt.Character == 'n'
    browseEvFT nextEvent
end
if evnt.Character == 'p'
    browseEvFT previousEvent
end
