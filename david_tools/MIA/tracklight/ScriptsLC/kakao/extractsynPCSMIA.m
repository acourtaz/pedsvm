...
str=['msd',filesep,'cut',filesep,filename,'.MIA.deco.syn.msd'];
if length(dir(str))>0		
      msddata =load(str);
      SPok=1;
...
str=['trc',filesep,'cut',filesep,filename,'.MIA.deco.syn.trc'];
if length(dir(str))>0		
      trcdata =load(str);
      SPok=1;
      disp(['File ' ,str, ' loaded.']);
...
% by Cezar M. Tigaret on 23/02/07
  ...
  %  save(['msd\cut\molecules\',filename,'.MIA.deco.molecule.',Num2str(i),'.msd.dat'],'temp','-ascii'); 
    ...
    save(['msd',filesep,'cut',filesep,'molecules',filesep,filename,'.MIA.deco.molecule.',num2str(i),'.msd.dat'],'temp','-ascii'); 
...
%    save(['trc\cut\molecules\',filename,'.MIA.deco.molecule.',Num2str(Ipart),'.trc.dat'],'iTrc','-ascii');
    save(['trc',filesep,'cut',filesep,'molecules',filesep,filename,'.MIA.deco.molecule.',num2str(Ipart),'.trc.dat'],'iTrc','-ascii');
end
...
save(['msd',filesep,'cut',filesep,'fits',filesep,filename,'.MIA.deco.fit.dat'],'touslesfits','-ascii');
