...
for i = 1:size(list_files,1)
    ...
    if isxls
        ...
        pooled5 = [pooled5,data5(6,5:end)']; %3 all; 6 terminal; 9 nTerm
        pooled7 = [pooled7,data7(6,5:end)']; %3 all; 6 terminal; 9 nTerm
        pooledR = [pooledR,dataR(6,5:end)']; %3 all; 6 terminal; 9 nTerm
        timeR = dataR(1,5:end);
        ...
        norm5 = (data5(6,5:end)' - median5)./(high5 - median5); %3 all; 6 terminal; 9 nTerm
        norm5 = [median5;(high5 - median5);norm5];
        norm7 = (data7(6,5:end)' - median7)./(high7 - median7); %3 all; 6 terminal; 9 nTerm
        norm7 = [median7;(high7 - median7);norm7];
        normR = (dataR(6,5:end)' - medianR)./(highR - medianR); %3 all; 6 terminal; 9 nTerm
        ...
        sumPar{end,6} = data5(7,3)/(data5(7,3)+data5(10,3));% fraction Terminal
        [peakR,iPeak] = max(dataR(6,5:end)); %3 all; 6 terminal; 9 nTerm
        ...
        sumPar{end,9} = peakR; %absolute peak
