function avFluo5(varargin)

%Written by DP 6/9/05 updated feb 2006, sep 2006, april 2007, feb 2014
%avFluo5 differs from avFluo4 because it has 5 arguments
%With varargin, avFluo4(events,stack,coeff,xls_fname,fig_name), batch mode
