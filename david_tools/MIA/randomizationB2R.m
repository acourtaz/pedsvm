function randomizationB2R(nTrials)

%written by David Perrais, 25/10/08
%creates a number of randomized traces for determining the significance
%of a recruitment profile
%inputs: B2R5.stk, B2R7.stk, pro5.stk, pro7.stk, events, coeff, mask
...
pause(0.1)
[stkGre5,stkdGre5] = uigetfile('*.stk','Stack of B2R at pH 5');
...
pause(0.1)
[stkGre7,stkdGre7] = uigetfile('*.stk','Stack of B2R at pH 7');
...
first_pH = 7;
bleed = 0.0; % normally around 0.032
time_int = 4;
...
headerEnv{6,6} = 'B2R_7';
headerEnv{6,11} = 'B2R_5';
cellEnv = [headerEnv;cellEnv];
sheets = {[cellN,' env'],[cellName,'_rnd'],[cellN,'_B2R7 rnd'],...
    [cellN,'_B2R5 rnd']};
