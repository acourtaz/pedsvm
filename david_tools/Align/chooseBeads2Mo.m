function chooseBeads2Mo(action)
...
if nargin == 0
   ...
   uicontrol('position',[170,10,100,20],'string',...
       'Fit & Save','callback','chooseBeads2 saveFit')
   ...
   case 'zoomOn'
      ...
      if zoomStatus
         ...
         zoom off
         set(findobj('tag','leftImage'),'ButtonDownFcn','chooseBeads2 pickLeft')
   ...
   case 'pickLeft'
      if strcmp(get(gcf,'selectiontype'),'normal')
         ...
         set(findobj('tag','rightImage'),'ButtonDownFcn','chooseBeads2 pickRight')
         drawline(leftBead) 
      end
   ...
   case 'calcCoeff'
      ...
      pause(0.1)
      [rcoFile,pr] = uiputfile([coFile(1:end-4),'Rev.txt'],'Save reverse transformation coefficients');
